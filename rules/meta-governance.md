...
- Contains `AGENTS.md` skeleton with placeholders (canonical, cross-tool; `CLAUDE.md` is a pointer that
  `@import`s it; no `GEMINI.md` is shipped)
...
- AGENTS.md skeleton updates (and the CLAUDE.md pointer)
...
- Documentation patterns: `[LEARN:documentation] Update AGENTS.md + README together`
...
| AGENTS.md skeleton (+ CLAUDE.md pointer) | Template repo | git clone / template |
...
- Do: Update AGENTS.md when adding features or changing workflow
...
Configure default clustering in AGENTS.md for your project.
```
